...
if __name__ == "__main__":
    ...
    FileSaver.SaveDataframe(_geneCluster, _config["Paths"]["GENE_CLUSTER_MF_HYPER_HIERARCY_WARD_PATH"])
    FileSaver.SavePlot(_silhouette, _config["Paths"]["GENE_MF_HYPER_HIERARCY_WARD_SILHOUETTE_PATH"])