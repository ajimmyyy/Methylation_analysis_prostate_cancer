...
if __name__ == "__main__":
    ...
    fn_cluster = "Data/110820004/Data-gosemsim/goterm_hypo_cluster.png"
    # fn_group = "Data/110820004/Data-gosemsim/goterm_group_hyper.csv"
    fn_group = "Data/110820004/Data-gosemsim/goterm_group_hypo.csv"
    threshold_hyper = 2.9
    threshold_hypo = 2.1
    ...
    clusters = hierarchy.fcluster(row_linkage, t=threshold_hypo, criterion='distance')
    data = {
        "gene": attributes,
        "cluster": clusters
    }
